...
type OmeletteTable struct {
    ...
    TableName string    `gorm:"type:varchar(255);not null" json:"table_name" validate:"required,min=3,max=255"`
...
type OmeletteList struct {
    ...
    ListName string    `gorm:"type:varchar(255);not null" json:"list_name" validate:"required,min=3,max=255"`
...
type OmeletteCard struct {
    ...
    CardName  string    `gorm:"type:varchar(255);not null" json:"card_name" validate:"required,min=3,max=255"`
    Position  int       `gorm:"not null" json:"position"`
    CreatedAt time.Time `gorm:"autoCreateTime" json:"created_at"`
    UpdatedAt time.Time `gorm:"autoUpdateTime" json:"updated_at"`
}
